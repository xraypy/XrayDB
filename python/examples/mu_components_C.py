...
plt.plot(energy, mu_total, linewidth=3, label='Total')
plt.plot(energy, mu_photo, linewidth=3, label='Photo-electric')
plt.plot(energy, mu_incoh, linewidth=3, label='Incoherent')
plt.plot(energy, mu_coher, linewidth=3, label='Coherent')
