...
.. module:: _xraydb
   :synopsis: X-ray Properties of the Elements

The xraydb Python module provides tabulated values for X-ray properties of
elements and compounds.  Several functions are available to access these
properties, and can be broken into two general categories: X-ray properties
of elements, and properties of materials and compounds by chemical formula.
...
:cite:ts:`Elam_etal`.  The core-hole widths for excited electronic levels
...
Compositional data for several common materials are included with XrayDB
...
.. function:: chemparse(formula)
   ...
   keys and number for each element as values.  For example::
        ...
        python> chemparse("H2O")
        {'H': 2.0, 'O': 1}
	python> chemparse("Mg0.2Fe0.8(SO4)2")
...
.. function:: material_add(name, formula, density)
   ...
   add material with name, chemical formula, and density.
   material names are not case sensitive.

.. todo::

   How to best store this user-specific data?
...
.. function:: material_mu(name_or_formula, energy, density=None)
   ...
   or formula and density.
    ...
    uses :func:`mu_elam`. Example::
      ...
      python> print material_mu('water', 10000.0)
      5.32986401658495
      python> print material_mu('H2O', 10000.0, density=1.0)
      5.32986401658495
...
.. function:: material_mu_components(name_or_formula, energy, density=None)
    ...
    For example::
       ...
       python> material_mu_components('quartz', 10000)
