...
from about 250 eV to about 200,000 eV.  Elements with Z=1 to 92 are
supported, and some data for elements between Z=93 and Z=98 is included.

A Poster-sized X-ray Periodic Table of the Elements built from these data
is also included.
