...
\newcommand{\Version}{\small{\textsf{Version 6, 2025-September-22}}}
 ...
 \newcommand{\WebURL}{\small{\textsf{https://xraydb.seescience.org}}}
...
\usetikzlibrary{shapes,calc,arrows}
  ...
  \pgfdeclareimage[height=30mm]{qrsees}{images/sees_qr}
  \pgfdeclareimage[height=24mm]{qrseessmall}{images/sees_qr}
